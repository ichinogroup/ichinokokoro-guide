...
const data = {
  en: {
    ...
    items: [
      ...
      ["Other Notes", "◆ <b>Please turn on the range hood when cooking to prevent cooking smoke from triggering the fire alarm and causing odors to linger in the house.<br><img src='assets/images/range-hood.png' style='width:100%; max-width:320px; border-radius:10px;'><br><br>◆ <b>Please be careful with the stairs if you are traveling with small children."],
      [
  "House Rules",
`<div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; line-height: 1.6;">
  ...
  jp: {
    ...
    items: [
      ...
      ["その他注意", "◆ <b>料理をする際は換気扇（レンジフード）を必ずつけてください。料理の煙が火災報知器を作動させたり、家の中に臭いが染み付いたりするのを防ぐためです。<br><img src='assets/images/range-hood.png' style='width:100%; max-width:320px; border-radius:10px;'><br><br>◆ <b>小さなお子様連れの場合は、階段に十分ご注意ください。"],
      [
      "ハウスルール",
`<div style="font-family: Arial, sans-serif; max-width: 850px; margin: 0 auto; line-height: 1.7;">
  ...
  cn: {
    ...
    items: [
      ...
      ["空调调节",`<a href="assets/pdf/空调.pdf" target="_blank">Open PDF Guide</a>` ],
      ...
      ["其他注意事项", "◆ <b>做饭时请打开抽油烟机，以免油烟触发火灾报警器，并防止气味残留在屋内。<br><img src='assets/images/range-hood.png' style='width:100%; max-width:320px; border-radius:10px;'><br><br>◆ <b>如果您带有小孩同行，请注意楼梯安全。"],
      [
      "房屋规则",
